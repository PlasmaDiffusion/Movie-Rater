...
return(<React.Fragment>
    <div className="listedMovie" prop={"movie" + props.id} onClick={()=>{setMovieSelected(true)}}>
       {props.movie.title.length < 30 ? <p className="movieName">{props.movie.title}</p> : <p className="movieName text-small">{props.movie.title}</p> }
      <p className="stars">★★★☆☆</p>
      <img src={"https://image.tmdb.org/t/p/original/" + props.movie.poster_path } width={256} height={256}></img>
    </div>
